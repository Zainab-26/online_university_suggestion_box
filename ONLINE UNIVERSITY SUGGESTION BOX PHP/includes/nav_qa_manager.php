<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar1" onclick="toggleSidebar()">
    ...
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="manage_category.php">
    ...
    <li class="nav-item">
        <a class="nav-link" href="index.html">
            ...
            <span>QA Manager Dashboard</span></a>
    </li>
    ...
    <li class="nav-item">
        <a class="nav-link" href="manage_ideas_qa_manager.php">
            <i class="fas fa-comment-alt"></i>
            <span>Manage Ideas</span></a>
    </li>
